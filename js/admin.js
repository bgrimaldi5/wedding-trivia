...
async function resetGame() {
  ...
  // Step 1: Delete ALL answers first (must go before players due to foreign key)
  ...
  // Step 2: Delete ALL players (this wipes scores too since score lives on the player row)
  ...
  // Step 3: Generate a new reset token — players on play.html will detect
  // the token mismatch and be immediately redirected to the join page
